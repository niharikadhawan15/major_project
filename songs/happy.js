...
$( document ).ready(function() {
    ...
    speechRs.speechinit('Google हिन्दी',function(e){
	        speechRs.speak("Please Select your happy song to be played", function() {
                   //speaking completed.
               }, false);
      });
...
$('#add-song').on('click',function(){
    ...
    songs.push({
        ...
        'album' : 'Album#' + (songs.length+1),
        'duration' : add_song_duration,
        'fileName' : 'song' + (songs.length+1) + '.mp3',
        'image' : 'default.jpg'
    });
  $('#songs tbody').append('<tr class="song" id="song' + (songs.length+1) + '"><td class="song-name"></td><td class="song-artist"></td><td class="song-album"></td><td class="song-length"></td></tr>');
